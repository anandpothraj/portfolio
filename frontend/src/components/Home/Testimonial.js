...
const Testimonial = () => {
    ...
    return (
        <div className="col-11 col-md-9 mx-auto my-5 text-light">
            <h1>Testimonials</h1>
            <Swiper slidesPerView={1} spaceBetween={30} pagination={{clickable: true}} modules={[Pagination]} className="mySwiper">
                <SwiperSlide>
                    <div className="col-12 mx-auto my-4 bg-light rounded text-dark d-flex flex-column flex-md-row">
                        <div className="col-12 col-md-4 testBg d-flex py-2 rounded flex-column">
                        ...
                        <div className="col-12 col-md-8 my-2 my-md-auto px-md-5">
                ...
                <SwiperSlide>
                    <div className="col-12 mx-auto my-4 bg-light rounded text-dark d-flex flex-column flex-md-row">
                        <div className="col-12 col-md-4 testBg d-flex py-2 rounded flex-column">
                            <Image src={Avatar2} fluid className="w-50 h-auto rounded-circle m-auto"/>
                            <div className="my-1">
                                <a href="https://www.linkedin.com/in/" target="_blank" rel="noreferrer"><BsLinkedin className="m-2 socialIcon text-dark"/></a>
                                <a href='https://twitter.com/' target="_blank" rel="noreferrer"><BsTwitter className="m-2 socialIcon text-dark"/></a>
                            </div>
                ...
                <SwiperSlide>
                    <div className="col-12 mx-auto my-4 bg-light rounded text-dark d-flex flex-column flex-md-row">
                        <div className="col-12 col-md-4 testBg d-flex py-2 rounded flex-column">
                            <Image src={Avatar3} fluid className="w-50 h-auto rounded-circle m-auto"/>
                            <div className="my-1">
                                <a href="https://www.linkedin.com/in/" target="_blank" rel="noreferrer"><BsLinkedin className="m-2 socialIcon text-dark"/></a>
                                <a href='https://twitter.com/' target="_blank" rel="noreferrer"><BsTwitter className="m-2 socialIcon text-dark"/></a>
                            </div>
                ...
                <SwiperSlide>
                    <div className="col-12 mx-auto my-4 bg-light rounded text-dark d-flex flex-column flex-md-row">
                        <div className="col-12 col-md-4 testBg d-flex py-2 rounded flex-column">
                            <Image src={Avatar4} fluid className="w-50 h-auto rounded-circle m-auto"/>
                            <div className="my-1">
                                <a href="https://www.linkedin.com/in/" target="_blank" rel="noreferrer"><BsLinkedin className="m-2 socialIcon text-dark"/></a>
                                <a href='https://twitter.com/' target="_blank" rel="noreferrer"><BsTwitter className="m-2 socialIcon text-dark"/></a>
                            </div>
